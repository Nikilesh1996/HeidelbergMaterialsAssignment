...
[TestClass]
public class SpaceXSearchWebApp_Component_Tests_MSTestAssemblyHooks
{
    [AssemblyInitialize]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public static void AssemblyInitialize(TestContext testContext)
    {
        var currentAssembly = typeof(SpaceXSearchWebApp_Component_Tests_MSTestAssemblyHooks).Assembly;
